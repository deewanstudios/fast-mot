<section class="color1">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
         ...
         <h1  class="title-h1" >Contact Form Confirmation:</h1>
...
<script type="text/javascript">
    ...
    if (parseInt(i.innerHTML)===3) {
        //local
        // location.href = "http://localhost:8888/FastMotGarrage";
        
        //testing remote
         // location.href = "http://fastmot.perfectcode.co.uk/home";
         
         //live
         location.href = "http://fastmot.com/home";
